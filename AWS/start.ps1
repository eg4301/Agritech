...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a29hjx8aa2fj0d-ats.iot.us-east-2.amazonaws.com --ca_file root-CA.crt --cert ESP32_all_in_one_sensor.cert.pem --key ESP32_all_in_one_sensor.private.key --client_id basicPubSub --topic sdk/test/python --count 0